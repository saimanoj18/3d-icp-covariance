...
int main(int argc, char** argv)
{
    ...
    cout << "Started Point to Point ICP" << endl;
    ...
    for (int i = 0; i < iterations; i++)
    {
        ...
        pcl::registration::TransformationEstimationSVD<pcl::PointXYZ, pcl::PointXYZ> pp_svd;
    ...
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> single_color1(cld1.makeShared(), 255, 0, 0);
    viewer->addPointCloud<pcl::PointXYZ> (cld1.makeShared(), single_color1, "sample cloud1");
    viewer->setPointCloudRenderingProperties (pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 4, "sample cloud1");
    viewer->initCameraParameters ();

    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> single_color2(cld2.makeShared(), 0, 255, 0);
    viewer->addPointCloud<pcl::PointXYZ> (cld2.makeShared(), single_color2, "sample cloud2");
